  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          if (leftMenu != null) {
            _maxWidth += constraints.maxWidth * widget.percentageBias;
            _maxDragFromLeftToRight = constraints.maxWidth * widget.percentageBias;
          ...
          if (rightMenu != null) {
            _maxWidth += constraints.maxWidth * widget.percentageBias;
            _maxDragFromRightToLeft = 0 - constraints.maxWidth * widget.percentageBias;
          }
          ...
          return GestureDetector(
            ...
            onHorizontalDragEnd: (DragEndDetails details) {
              ...
              double minShift = constraints.maxWidth * widget.minShiftPercent;
              ...
              if (offsetXActual < 0) {
                ...
                if ((!isOpened && offsetXSaved.abs() < minShift)
                  || (isOpened && constraints.maxWidth + offsetXSaved >= minShift))
                  slideController.close();
                else
